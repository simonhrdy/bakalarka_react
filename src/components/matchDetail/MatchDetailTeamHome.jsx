...
export default function MatchDetailTeamHome(props) {
    ...
    return (
        <>
            <div className="rounded-lg flex items-center  gap-3 lg:gap-6 w-fit matchDetailTeam matchDetailTeamHome">
                <div className="bg-white p-3 rounded-lg lg:hidden flex-col items-center shadow-md absolute hidden">
                ...
                >
                    <span className="lg:text-3xl md:text-3xl text-xl">⭐</span>
